        ...
        <div className="row d-flex justify-content-center">
            {Connectionslist.map((conn)=>{
                return(
                    ...
                    {<button id={`${conn.id}`} className="position-absolute bg-transparent  border-0 end-0 m-2" style={{width:'fit-content'}} onClick={()=>{connect(conn) ; }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="green" class="bi bi-plus-circle" viewBox="0 0 16 16">
                    ...
                    {/* <Link to={`/connectiondetails/${conn.id}`} className="text-decoration-none "> */}
                        ...
                        <h4 class="card-title text-light fw-bold ">{conn.firstName+" "+conn.lastName}</h4>
                        <div className="d-flex flex-row align-items-center justify-content-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="white" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                        </svg>
                        <h6 class="card-title text-light fw-bold ms-1" >{conn.address.city}</h6>
                        </div>
                        <div className="d-flex flex-row align-items-center justify-content-start">
                        ...
                        <h6 class="card-title text-light fw-bold ms-1" >{conn.company.name}</h6>
                        </div>
                        </div>
                    {/* </Link> */}
                    </div>
