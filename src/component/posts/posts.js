            ...
            {this.state.postlist.map((post) => (
                ...
                <Card style={{
                    ...
                    <Card.Body>
                        ...
                        <div className="postBottom">
                            <div className="postBottomLeft">
                                <img
                                    className="likeIcon"
                                    // onClick={likeHandler}
                                    src={"https://cdn.vectorstock.com/i/1000x1000/99/82/like-icon-on-blue-circle-vector-22509982.webp"}
                                    alt="like"
                                />
                                <img
                                    className="likeIcon"
                                    // onClick={likeHandler}
                                    src={"https://png.pngtree.com/png-clipart/20190516/original/pngtree-facebook-love-icon-png-image_3584863.jpg"}
                                    alt="heart"
                                />
                        ...
                        <button type="button" onclick="increment()" class="btn">LIKE</button>
                        <button type="button" onclick="increment()" class="btn2">Love</button>
                        <button type="button" onclick="decrement()" class="btn3">Dis Like</button>
                        <p>Likes: <a id="counting">0</a></p>
                        <p>Loves: <a id="counting">0</a></p>
